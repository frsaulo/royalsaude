...
// @ts-ignore
import pdfPolicy from "@/assets/Termos de Uso, Privacidade e LGPD - Royal Med Health.pdf";
      ...
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-slate-200">
        <div className="flex items-center justify-between mb-8 border-b pb-6">
          ...
          <div className="flex gap-4">
            <a href={pdfPolicy} download="Politica_Privacidade_RoyalMed.pdf" target="_blank" rel="noopener noreferrer">
        ...
        <div className="prose prose-slate max-w-none">
          <h1 className="text-3xl font-bold text-[#1E3A8A] mb-8 text-center">Política de Privacidade, Cookies e LGPD</h1>
          
          <p className="text-slate-600 mb-6">
            Este documento contém os Termos de Uso, Política de Privacidade e Proteção de Dados da Royal Med Health.
