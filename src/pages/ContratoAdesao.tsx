      ...
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-slate-200">
        <div className="flex items-center justify-between mb-8 border-b pb-6">
          ...
          <div className="flex gap-4">
            <a href={pdfPolicy} download="Contrato_Adesao_RoyalMed.pdf" target="_blank" rel="noopener noreferrer">
        ...
        <div className="prose prose-slate max-w-none">
          <h1 className="text-3xl font-bold text-[#1E3A8A] mb-8 text-center">Contrato de Adesão</h1>
          
          <p className="text-slate-600 mb-6">
            Este documento contém o Contrato de Adesão de Usuário Final da Royal Med Health.
