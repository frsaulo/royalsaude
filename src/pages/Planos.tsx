    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-[#dde400]/5">
      ...
      <main className="container mx-auto max-w-5xl px-4 py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-[#dde400]/10 text-[#6a6d00] px-4 py-2 rounded-full text-sm font-semibold mb-6">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge
                  ...
                  className={`font-bold ${
                    dependentsCount > 3
                      ? "text-[#6a6d00] border-[#dde400]/30 bg-[#dde400]/10"
              ...
              {dependentsCount > 3 && (
                <p className="text-xs text-[#6a6d00] mt-3 bg-[#dde400]/10 rounded-lg px-3 py-2">
                  ...
                  {features.map((f, i) => (
                    <div key={i} className="flex items-center gap-3 text-sm text-slate-700">
                      <div className="h-6 w-6 rounded-full bg-[#dde400]/10 flex items-center justify-center flex-shrink-0">
                        <Check className="h-3.5 w-3.5 text-[#6a6d00]" />
                      </div>
                      {f.text}
                    </div>
                  ))}
