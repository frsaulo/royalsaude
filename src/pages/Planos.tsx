      ...
      <main className="container mx-auto max-w-5xl px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Acesso completo a consultas, telemedicina e acompanhamento de saúde
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          {/* Yearly Plan */}
          {yearlyPlan && (
            <Card className="relative border-2 border-amber-400 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-amber-50/30 overflow-hidden group">
              {/* Best Value Badge */}
              <div className="absolute top-0 right-0">
                <div className="bg-gradient-to-r from-amber-500 to-amber-600 text-white text-xs font-bold px-4 py-1.5 rounded-bl-xl flex items-center gap-1">
              ...
              <CardContent className="space-y-6">
                ...
                <Button
                  className="w-full h-12 text-base font-semibold bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white shadow-lg shadow-amber-200"
