...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md border-b border-gold-light/30" style={{ backgroundColor: '#2566af' }}>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="md:hidden border-t border-gold-light/30" style={{ backgroundColor: '#2566af' }}
          >
